...
import com.example.practica_final.databinding.ItemCartaMagicBinding
import com.google.firebase.database.FirebaseDatabase


class CartaAdapter(private val context: Context, private val listaCarta: MutableList<Carta_Magic>): RecyclerView.Adapter<CartaAdapter.CartaViewHolder>() {
    private lateinit var lista_filtrada: MutableList<Carta_Magic>
    private lateinit var contexto: Context

    inner class  CartaViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        lateinit var binding: ItemCartaMagicBinding
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartaViewHolder {
        val vista_item = LayoutInflater.from(parent.context).inflate(R.layout.item_carta_magic, parent, false)
